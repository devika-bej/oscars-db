...
--
-- Host: 127.0.0.1    Database: phase_4
-- ------------------------------------------------------
...
CREATE TABLE `Artist_Nomination` (
  ...
  CONSTRAINT `Artist_Nomination_ibfk_2` FOREIGN KEY (`Category`) REFERENCES `Award_Category` (`Award_Category_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Director` (`Artist_Id`, `Gender`) VALUES (26,'Female'),(27,'Female'),(28,'Male'),(29,'Male'),(30,'Male'),(31,'Male'),(32,'Male'),(33,'Female'),(34,'Male'),(35,'Female'),(36,'Male'),(37,'Male'),(38,'Male'),(39,'Male'),(40,'Male'),(41,'Male'),(42,'Male'),(54,'Male'),(59,'Male');
...
INSERT INTO `Family_Member` (`Member_Id`, `Name`, `Relation`) VALUES (1,'Jane Hajduk','Spouse'),(2,'Rita Wilson','Spouse'),(3,'Jim Hanks','Brother'),(4,'Alexandra Grant','Spouse'),(5,'Maggie Baird','Mother'),(6,'Nick Young','Cousin'),(7,'Baby Keem','Cousin');
...
CREATE TABLE `Featured_In` (
  ...
  CONSTRAINT `Featured_In_Movie` FOREIGN KEY (`Movie_Id`) REFERENCES `Movie` (`Movie_Id`),
  CONSTRAINT `Featured_In_Song` FOREIGN KEY (`Song_Id`) REFERENCES `Song` (`Song_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Featured_In` (`Song_Id`, `Movie_Id`) VALUES (8,20143),(6,20183),(3,20203);
...
INSERT INTO `Genre` (`Genre_Id`, `Name`) VALUES (1,'Pop'),(2,'Rock'),(3,'Hip-Hop'),(4,'Country'),(5,'Jazz'),(6,'Electronic'),(7,'R&B'),(8,'Classical'),(9,'Blues'),(10,'Reggae'),(11,'Desi'),(12,'Folk');
...
CREATE TABLE `Movie` (
  ...
  KEY `Movie_result` (`Result`),
  CONSTRAINT `Movie_Director_FK` FOREIGN KEY (`Director_Id`) REFERENCES `Director` (`Artist_Id`),
  CONSTRAINT `Movie_result` FOREIGN KEY (`Result`) REFERENCES `Result` (`Result_Id`)
...
CREATE TABLE `Played` (
  ...
  CONSTRAINT `Played_ibfk_1` FOREIGN KEY (`Artist_Id`) REFERENCES `Actor` (`Artist_Id`),
  CONSTRAINT `Played_ibfk_3` FOREIGN KEY (`Character_Id`) REFERENCES `Character_Table` (`Character_Id`),
  CONSTRAINT `Played_Movie` FOREIGN KEY (`Movie_Id`) REFERENCES `Movie` (`Movie_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Played` (`Artist_Id`, `Movie_Id`, `Character_Id`) VALUES (19,20143,1),(18,20143,2),(17,20163,3),(15,20173,4),(16,20173,5),(14,20193,6),(11,20203,7),(12,20203,8),(13,20203,9),(9,20223,10),(10,20223,11),(1,20221,12),(2,20221,13),(5,20201,14),(4,20201,15),(6,20191,16);
...
INSERT INTO `Related_To` (`Artist_Id`, `Member_Id`) VALUES (12,1),(11,2),(11,3),(13,4),(21,5),(22,6),(23,7);
...
CREATE TABLE `Result` (
  ...
  KEY `result_fk_movie_id` (`Movie_Id`),
  CONSTRAINT `result_fk_movie_id` FOREIGN KEY (`Movie_Id`) REFERENCES `Movie` (`Movie_Id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=2023714 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Result` (`Result_Id`, `Won`, `Place`, `Year`, `Category`, `Movie_Id`) VALUES (2014301,1,'1',2014,'3',20143),(2015301,1,'1',2015,'3',20153),(2016101,1,'1',2016,'1',20161),(2016301,1,'1',2016,'3',20163),(2017101,1,'1',2017,'1',20171),(2017301,1,'1',2017,'3',20173),(2018101,1,'1',2018,'1',20181),(2018301,1,'1',2018,'3',20183),(2019101,1,'1',2019,'1',20191),(2019301,1,'1',2019,'3',20193),(2020101,1,'1',2020,'1',20201),(2020301,1,'1',2020,'3',20203),(2021101,1,'1',2021,'1',20211),(2021301,1,'1',2021,'3',20213),(2022101,1,'1',2022,'1',20221),(2022301,1,'1',2022,'3',20223),(2023101,1,'1',2023,'1',20231),(2023301,1,'1',2023,'3',20233),(2023702,1,'1',2023,'4',20231),(2023703,1,'1',2023,'5',20231),(2023704,1,'1',2023,'6',20231),(2023705,0,NULL,2023,'9',20231),(2023706,0,NULL,2023,'12',20231),(2023707,0,NULL,2023,'14',20231),(2023708,0,NULL,2023,'20',20231),(2023709,0,NULL,2023,'2',20231),(2023710,0,NULL,2023,'19',20231),(2023711,0,NULL,2022,'10',20221),(2023712,0,NULL,2014,'1',NULL),(2023713,0,NULL,2016,'1',NULL);
...
CREATE TABLE `Sang` (
  ...
  CONSTRAINT `Sang_ibfk_1` FOREIGN KEY (`Artist_Id`) REFERENCES `Singer` (`Artist_Id`),
  CONSTRAINT `Sang_Song` FOREIGN KEY (`Song_Id`) REFERENCES `Song` (`Song_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Sang` (`Artist_Id`, `Song_Id`) VALUES (20,1),(21,2),(23,4),(22,5),(25,5),(24,7),(19,8);
...
INSERT INTO `Singer` (`Artist_Id`) VALUES (19),(20),(21),(22),(23),(24),(25);
...
CREATE TABLE `Song` (
  ...
  CONSTRAINT `Song_genre` FOREIGN KEY (`Genre_Id`) REFERENCES `Genre` (`Genre_Id`)
...
INSERT INTO `Wins` (`Movie_Id`, `Ceremony_Year`, `Artist_Id`, `Award_Category_Id`, `Winner`) VALUES (20143,2014,NULL,7,1),(20143,2014,19,20,1),(20153,2014,NULL,7,1),(20161,2015,NULL,1,1),(20161,2016,32,2,0),(20161,2016,53,5,0),(20161,2016,52,6,0),(20161,2016,NULL,9,0),(20161,2016,NULL,12,0),(20163,2015,NULL,7,1),(20163,2016,NULL,9,0),(20165,2017,NULL,1,0),(20165,2017,59,2,1),(20165,2017,24,3,0),(20165,2017,61,4,1),(20165,2017,NULL,9,0),(20165,2017,NULL,11,1),(20165,2017,NULL,12,0),(20165,2017,NULL,13,1),(20165,2017,NULL,14,0),(20165,2017,NULL,17,0),(20165,2017,NULL,18,0),(20165,2017,NULL,19,0),(20165,2017,24,20,1),(20171,2016,NULL,1,1),(20171,2017,31,2,0),(20171,2017,47,5,1),(20171,2017,51,6,0),(20171,2017,NULL,10,1),(20171,2017,NULL,11,0),(20171,2017,NULL,12,0),(20171,2017,NULL,19,0),(20173,2016,NULL,7,1),(20181,2017,NULL,1,1),(20181,2018,30,2,1),(20181,2018,48,4,0),(20181,2018,49,5,0),(20181,2018,50,6,0),(20181,2018,NULL,9,0),(20181,2018,NULL,11,0),(20181,2018,NULL,12,0),(20181,2018,NULL,13,1),(20181,2018,NULL,14,0),(20181,2018,NULL,17,0),(20181,2018,NULL,18,0),(20181,2018,NULL,19,1),(20183,2017,NULL,7,1),(20183,2018,NULL,20,1),(20191,2018,NULL,1,1),(20191,2019,6,3,0),(20191,2019,47,5,1),(20191,2019,NULL,9,1),(20191,2019,NULL,12,0),(20193,2018,NULL,7,1),(20201,2019,NULL,1,1),(20201,2020,29,2,1),(20201,2020,NULL,8,1),(20201,2020,NULL,9,1),(20201,2020,NULL,12,0),(20201,2020,NULL,13,0),(20203,2019,NULL,7,1),(20211,2020,NULL,1,1),(20211,2021,26,2,1),(20211,2021,46,4,1),(20211,2021,NULL,10,0),(20211,2021,NULL,11,0),(20211,2021,NULL,12,0),(20213,2020,NULL,7,1),(20213,2021,NULL,17,0),(20213,2021,NULL,19,1),(20221,2021,NULL,1,1),(20221,2022,NULL,5,1),(20221,2022,NULL,10,1),(20223,2021,NULL,7,1),(20223,2022,NULL,19,0),(20223,2022,NULL,20,0),(20231,2022,NULL,1,1),(20231,2023,28,2,1),(20231,2023,43,4,1),(20231,2023,44,5,1),(20231,2023,45,6,1),(20231,2023,NULL,9,0),(20231,2023,NULL,12,0),(20231,2023,NULL,14,0),(20231,2023,NULL,19,0),(20231,2023,NULL,20,0),(20233,2022,NULL,7,1),(20234,2014,NULL,1,0),(20234,2014,54,2,0),(20234,2014,55,3,0),(20234,2014,56,4,0),(20234,2014,58,5,0),(20234,2014,57,6,0),(20234,2014,NULL,9,0),(20234,2014,NULL,12,0),(20234,2014,NULL,13,0),(20234,2014,NULL,14,0);
...
-- Dump completed on 2023-12-02  7:03:14
